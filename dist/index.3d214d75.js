...
console.log(_momentDefault.default().format("MMMM Do YYYY, h:mm:ss a"));
console.log(_momentDefault.default().format("dddd"));
console.log(_momentDefault.default().format("MMM Do YY"));
let date1 = _momentDefault.default("2020-01-01");
console.log(date1.isValid());
let date2 = _momentDefault.default("2020-14-01");
console.log(date2.isValid());
console.log(_momentDefault.default().add(7, "days").calendar());
console.log(_momentDefault.default().add(7, "months").calendar());
console.log(_momentDefault.default().add(7, "years").calendar());
console.log(_momentDefault.default().subtract(7, "days").calendar());
console.log(_momentDefault.default().subtract(7, "months").calendar());
console.log(_momentDefault.default().subtract(7, "years").calendar());
let a = _momentDefault.default("2014-11-11");
let b = _momentDefault.default("2015-09-11");
console.log(b.diff(a, "days"));
let c = _momentDefault.default("2014-11-27");
let d = _momentDefault.default("2015-09-16");
console.log(d.diff(c, "days"));
console.log(_momentDefault.default("2020-01-01").isAfter("2018-01-01"));
console.log(_momentDefault.default("2010-01-01").isAfter("2018-01-01"));
console.log("Leap:", _momentDefault.default("2019").isLeapYear());
console.log("Leap:", _momentDefault.default("2020").isLeapYear());
...
var other = lodash.concat(array, 2, [
    3
], [
    [
        4
...
console.log(lodash.every(users, {
    user: "barney",
    active: false
}));
function square(n) {
...
console.log(lodash.reject(users, {
    age: 40
}));
console.groupEnd();

},{"moment":"jwcsj","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","lodash":"3qBDj"}],"jwcsj":[function(require,module,exports) {
...
},{}]},["aPJuQ","bB7Pu"], "bB7Pu", "parcelRequire1a8a")
